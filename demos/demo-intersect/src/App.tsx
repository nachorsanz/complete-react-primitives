...
function Block({ i }: { i: number }) {
  return (
    <div style={{ height: 300, margin: "16px 0", background: "#efefef", display: "grid", placeItems: "center" }}>
      Bloque {i}
    </div>
  );
}
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "system-ui", padding: 24 }}>
      ...
      <div
        ref={ref}
        style={{ height: 240, background: inView ? "#c6f6d5" : "#fde68a", display: "grid", placeItems: "center" }}
      >
